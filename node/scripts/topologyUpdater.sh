...
CNODE_CONFIG_DIR=/cardano/configs/${NETWORK}
CNODE_LOG_DIR="/cardano"
CNODE_PORT=${CNODE_PORT:-'3000'}  # must match your relay node port as set in the startup command
...
CONFIG_JSON="${CNODE_CONFIG_DIR}/${NETWORK}-config.json"
GENESIS_JSON="${CNODE_CONFIG_DIR}/${NETWORK}-shelley-genesis.json"
